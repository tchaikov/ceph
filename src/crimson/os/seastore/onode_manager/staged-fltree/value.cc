...
#define NXT_T(StageType)  staged<typename StageType::next_param_t>
    ...
    laddr_t i_value{0};
    auto insert_size_2 =
      _STAGE_T(InternalNode0)::template insert_size<key_hobj_t>(key, i_value);
    auto insert_size_0 =
      NXT_T(NXT_T(_STAGE_T(InternalNode0)))::template insert_size<key_hobj_t>(key, i_value);
    ...
    insert_size_2 =
      _STAGE_T(LeafNode0)::template insert_size<key_hobj_t>(key, l_value);
    insert_size_0 =
      NXT_T(NXT_T(_STAGE_T(LeafNode0)))::template insert_size<key_hobj_t>(key, l_value);
