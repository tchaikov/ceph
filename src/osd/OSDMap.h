...
private:
  ...
  struct addrs_s {
    ...
    mempool::osdmap::vector<ceph::shared_ptr<entity_addrvec_t> > cluster_addrs;
    mempool::osdmap::vector<ceph::shared_ptr<entity_addrvec_t> > hb_back_addrs;
    mempool::osdmap::vector<ceph::shared_ptr<entity_addrvec_t> > hb_front_addrs;
  };
